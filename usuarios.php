                    ...
                    <div class='card'>
                        ...
                        <div class="modal-dialog custom-width">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="staticBackdropLabel">Gestión de Usuarios</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <!-- Id -->
                                    <input type="hidden" id="idusuario" name="idproyecto" value="">
                                    <input type="hidden" id="modus" name="modus" value="<?php echo $perfil['modus']; ?>">
                            ...
                            <div class="row">
                                <div class="col">
                                <div class="form-group">
                                    <label for="subsede">Perfil</label>
                                    <select class="form-control" id="perfil">
                                        <option value="">Seleccione una opción</option>
                                    </select>
                                    <small id="textErrorPerfil" style="display:none;" class="form-text text-danger">Campo Requerido</small>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="textErrorPassword1" style="display:none;" class="form-text text-danger">Campo Requerido</small>
                                    <small id="textErrorPasswordDiferentes" style="display:none;" class="form-text text-danger">Las contraseñas deben ser iguales</small>
                                </div>
                                 </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="textErrorPassword2" style="display:none;" class="form-text text-danger">Campo Requerido</small>
                                </div>
                                 </div>
                            </div>
