    ...
    <div class='card'>
            ...
            <div class='card-header'>
                <h2><i class="fas fa-users"></i> Gestión de Dependientes </h2>
                <button type="button" id="btn-create" class="btn btn-success btn btn3d" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
