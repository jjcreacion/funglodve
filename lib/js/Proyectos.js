    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            proyectos.forEach(function(proyecto) {
                ...
                if (modpr.includes('R')) { 
                buttons += `<button type="button" id="btn-view" class="btn-sm btn-info btn btn3d" data-id="${proyecto.id}" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa-regular fa-eye"></i></button>`; 
                }
                if (modpr.includes('U')) { 
                buttons += `<button type="button" id="btn-edit" class="btn-sm btn-warning btn btn3d" data-id="${proyecto.id}" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa-duotone fa-solid fa-pen-to-square"></i></button>`;
                } 
                if (modpr.includes('D')) { 
                buttons += `<button type="button" id="btn-delete" class="btn-sm btn-danger btn btn3d" data-id="${proyecto.id}"><i class="fa-duotone fa-solid fa-trash"></i></button>`; 
                }
                buttons += `</div>`; 
