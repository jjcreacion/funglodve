...
$(document).ready(function () {
    ...
    $(document).on('click', '#btn-historial', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(historialDetalle.cmundiaes==1)
    ...
    var insertBasico = false;
    
    if($('#historialBasico').val() == '1')
        insertBasico = true;

    if($('#historialNacional').val() == '1')
        insertNacional = true;

    if($('#historialInternacional').val() == '1')
        insertInternacional = true;

    if($('#historialOtros').val() == '1')
        insertOtros = true;
    ...
    //Historial Nacional 
     let distrital = $('#distrital').val();
     let estatal = $('#estatal').val();
     let interclubes = $('#interclubes').val();
     let cnacionales = $('#cnacionales').val();
     let jnacionales = $('#jnacionales').val();
    ...
    //Historial Internacional
    let csuda = $('#csuda').val();
    let ccentro = $('#ccentro').val();
    let clatino = $('#clatino').val();
    let cboliva = $('#cboliva').val();
    let cpana = $('#cpana').val();
    let cibero = $('#cibero').val();
    let cligas = $('#cligas').val();
    let cmundiales = $('#cmundiales').val();
    let invitacionales = $('#invitacionales').val();
    let jsuda = $('#jsuda').val();
    let jcentro = $('#jcentro').val();
    let jlatino = $('#jlatino').val();
    let jboliva = $('#jboliva').val();
    let jpana = $('#jpana').val();
    let jalba = $('#jalba').val();
    let jjoo = $('#jjoo').val();
