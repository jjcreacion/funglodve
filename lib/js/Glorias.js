...
$(document).ready(function () {
        ...
        "columns": [
            ...
            { "data": "nombre_completo" },
            {
                ...
                "render": function (data, type, row) {
                    return `<div class="btn-container"><button type="button" id="btn-view" class="btn-sm btn-primary btn btn3d" data-id="${data.id}" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa-solid fa-people-roof"></i></button></div>`;
                }
            },
            {
                "data": null,
                "render": function (data, type, row) {
                    return `<div class="btn-container"><button type="button" id="btn-view" class="btn-sm btn-success btn btn3d" data-id="${data.id}" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa-solid fa-medal"></i></button></div>`;
                }
            },
            {
                "data": null,
    ...
    $(document).on('blur', '#cedula', function() {
        // Tu código aquí
       alert('El campo cedula ha perdido el foco.');
    }); 
